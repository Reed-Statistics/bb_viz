...
ui <- navbarPage(theme = shinytheme("flatly"),
                 ...
                 tabPanel("User Guide", 
                          ...
                          p("Estimated Distance: Projected flight path distance of batted ball (ft)",style = "font-size:15px"),
                          p("Hard Hit %: Proportion of batted balls with an exit velocity equal to or greater than 95 MPH",style = "font-size:15px"),
                          ...
                          p("Spin Rate: Rate of spin on a given pitch after its release (RPM)",style = "font-size:15px")
                          ),
